...
if( ! defined( 'RARA_ACADEMIC_THEME_VERSION' ) ) define ( 'RARA_ACADEMIC_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'RARA_ACADEMIC_THEME_NAME' ) ) define( 'RARA_ACADEMIC_THEME_NAME', $theme_data->get( 'Name' ) );
